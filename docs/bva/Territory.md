...
|-------------|-------------------|---------------------------------|---------------------------|
| Test Case 1 | null name         | IllegalArgumentException thrown | :x: or :white_check_mark: |
| Test Case 2 | empy name         | IllegalArgumentException thrown | :x: or :white_check_mark: |
