...
- **TC1: random = null → IllegalArgumentException** ( :white_check_mark: )
    - **State of the system**: no DeckManager constructed yet
    - **Expected output**: IllegalArgumentException thrown

- **TC2: random = valid Random → both piles empty** ( :white_check_mark: )
...
- **TC26: random = null → IllegalArgumentException** ( :white_check_mark: )
...
- **TC27: initialDrawPile = null → IllegalArgumentException** ( :white_check_mark: )
    - **State of the system**: no DeckManager constructed yet; random = valid Random
    - **Expected output**: IllegalArgumentException thrown

**`initialDrawPile` size (Count variable ≥ 0):**

- **TC28: initialDrawPile.size = 0 (lower bound) → both piles empty** ( :white_check_mark: )
    - **State of the system**: DeckManager constructed with random + empty list
    - **Expected output**: size() = 0, getDrawPileSize() = 0, getDiscardPileSize() = 0

- **TC29: initialDrawPile.size = 1 (one above lower bound) → draw pile holds that card, discard empty** ( :white_check_mark: )
...
- **TC30: initialDrawPile.size = 44 (real Risk deck size) → draw pile holds all 44 cards, discard empty** ( :white_check_mark: )
...
- **TC3: territories = null → IllegalArgumentException** ( :white_check_mark: )
    - **State of the system**: fresh DeckManager
    - **Expected output**: IllegalArgumentException thrown

- **TC4: territories contains a null entry → IllegalArgumentException** ( :white_check_mark: )
...
- **TC5: territories.size = 0 (lower bound) → 2 wildcards only** ( :white_check_mark: )
    - **State of the system**: fresh DeckManager; territories = []
    - **Expected output**: size() = 2, all cards have type WILDCARD and null Territory

- **TC6: territories.size = 1 (one above lower bound) → 1 INFANTRY + 2 wildcards** ( :white_check_mark: )
...
- **TC7: territories.size = 3 (one full round of type rotation) → INFANTRY/CAVALRY/ARTILLERY + 2 wildcards** ( :white_check_mark: )
...
- **TC8: territories.size = 42 (real Risk deck size) → 14 of each non-wildcard type + 2 wildcards** ( :white_check_mark: )
...
- **TC9: buildDeck called twice → second call replaces draw pile entirely** ( :white_check_mark: )
...
- **TC10: buildDeck called after returnCards → second call clears discard pile too** ( :white_check_mark: )
...
- **TC11: drawPile non-empty, discardPile empty → drawPile shuffled, discard untouched** ( :white_check_mark: )
...
- **TC12: drawPile non-empty, discardPile non-empty → only drawPile shuffled, discard untouched** ( :white_check_mark: )
...
- **TC13: drawPile empty, discardPile non-empty → discard merged into draw and shuffled** ( :white_check_mark: )
    - **State of the system**: drawPile is empty, discardPile has 2 cards
    - **Expected output**: drawPile size 2, discardPile size 0

- **TC14: drawPile empty, discardPile empty → no-op (no exception)** ( :white_check_mark: )
...
- **TC15: two DeckManagers seeded with the same Random produce the same shuffle order** ( :white_check_mark: )
...
- **TC16: drawPile.size = 1, discardPile empty → returns that card, draw becomes empty** ( :white_check_mark: )
...
- **TC17: drawPile.size = 2, discardPile empty → returns top card, draw shrinks by 1** ( :white_check_mark: )
...
- **TC18: drawPile empty, discardPile.size = 1 → auto-reshuffles, returns the recycled card** ( :white_check_mark: )
...
- **TC19: drawPile empty, discardPile empty → IllegalStateException** ( :white_check_mark: )
    - **State of the system**: both piles empty
...
- **TC20: cards = null → IllegalArgumentException** ( :white_check_mark: )
    - **State of the system**: fresh DeckManager
    - **Expected output**: IllegalArgumentException thrown

**`cards` size (Count variable ≥ 0, drives discardPile growth):**

- **TC21: cards.size = 0 (lower bound) → no-op** ( :white_check_mark: )
...
- **TC22: cards.size = 1 (one above lower bound) → 1 card added to discard, drawPile unchanged** ( :white_check_mark: )
    - **State of the system**: DeckManager has 3 cards in drawPile, 0 in discard
    - **Expected output**: drawPile size 3 (unchanged); discardPile size 1

- **TC23: cards.size = 3 (typical trade set size) → 3 cards added to discard, drawPile unchanged** ( :white_check_mark: )
    - **State of the system**: DeckManager has 3 cards in drawPile, 0 in discard
...
- **TC24: invariant holds when both piles non-empty** ( :white_check_mark: )
...
- **TC25: returned view rejects mutation → UnsupportedOperationException on add** ( :white_check_mark: )
